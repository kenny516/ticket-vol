                ...
                <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                    ...
                    <% SimpleDateFormat dateFormat = new
                        ...
                        (Reservation reservation : reservations) {
                            String villeDepart = (reservation.getPlaceVol().getVol() != null && reservation.getPlaceVol().getVol().getVilleDepart() != null) ? reservation.getPlaceVol().getVol().getVilleDepart().getNom() : "N/A";
                            String villeArrive = (reservation.getPlaceVol().getVol() != null && reservation.getPlaceVol().getVol().getVilleArrive() != null) ? reservation.getPlaceVol().getVol().getVilleArrive().getNom() : "N/A";
                            String dateDepart = (reservation.getPlaceVol().getVol() != null && reservation.getPlaceVol().getVol().getDateDepart() != null) ? dateFormat.format(reservation.getPlaceVol().getVol().getDateDepart()) : "N/A";
                            String typeSiege = (reservation.getPlaceVol().getTypeSiege() != null) ? reservation.getPlaceVol().getTypeSiege().getDesignation() : "Non spécifié";
                            int nombrePlaces = (reservation.getNombrePlaces() != null) ? reservation.getNombrePlaces() : 0;
                            double prixTotal = (reservation.getPrix() != null) ? reservation.getPrix() : 0.0;
                    ...
                    <tr class="hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors duration-200">
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-sm">
                            <% if (estValide) { %>
                            <span class="inline-flex items-center px-2.5 py-2 rounded-full text-xs font-medium bg-green-100 text-green-800 dark:bg-green-800 dark:text-green-100">
                                Confirmée
                            </span>
                            <% } else { %>
                            <span class="inline-flex items-center px-2.5 py-2 rounded-full text-xs font-medium bg-yellow-100 text-yellow-800 dark:bg-yellow-800 dark:text-yellow-100">
                                En attente
                            </span>
                            <% } %>
                        </td>
