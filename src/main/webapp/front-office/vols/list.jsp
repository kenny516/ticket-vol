                        ...
                        <tbody>
                            <c:forEach items="${vols}" var="vol">
                                <tr>
                                    ...
                                    <td>
                                        <c:if test="${not empty sessionScope.user}">
                                            <a href="${pageContext.request.contextPath}/reservations/create?volId=${vol.id}"
                                                class="btn btn-sm btn-primary">Réserver</a>
                                        </c:if>
                                        <c:if test="${empty sessionScope.user}">
                                            <a href="${pageContext.request.contextPath}/front-office/login"
                                                class="btn btn-sm btn-secondary">Connectez-vous pour réserver</a>
                                        </c:if>
                                    </td>
                                </tr>
                            </c:forEach>
