...
VALUES ('Dupont', 'Jean', 'client', 'jdupont', 'password123'),
       ('Martin', 'Sophie', 'admin', 'smartin', 'adminpass'),
       ('Bernard', 'Alice', 'client', 'abernard', 'alicepwd');
...
INSERT INTO parametre (heures_minimum_reservation, heures_minimum_annulation_)
VALUES (2, 24);

-- Insertion de données pour la table vol
-- (les id_ville et id_avion font référence aux enregistrements insérés précédemment)
INSERT INTO vol (date_depart, id_ville_depart, id_ville_arrive, id_avion)
VALUES ('2025-03-01 08:00:00', 1, 2, 1), -- Vol de Paris à Lyon avec Airbus A320
       ('2025-03-02 12:30:00', 3, 1, 2), -- Vol de Marseille à Paris avec Boeing 737
...
VALUES (150, 1, 1), -- 150 sièges Economique
       (20, 2, 1),  -- 20 sièges Business
       (10, 3, 1);
-- 10 sièges Première Classe

-- Pour l'avion 2 (Boeing 737)
INSERT INTO place (nombre, id_type_siege, id_avion)
VALUES (160, 1, 2), -- 160 sièges Economique
       (25, 2, 2),  -- 25 sièges Business
       (5, 3, 2);
...
VALUES (120.50, 1, 1), -- Tarif Economique
       (250.00, 1, 2), -- Tarif Business
       (400.00, 1, 3);
-- Tarif Première Classe

-- Pour le vol 2
INSERT INTO place_vol (prix, id_vol, id_type_siege)
VALUES (100.00, 2, 1), -- Tarif Economique
       (220.00, 2, 2), -- Tarif Business
       (350.00, 2, 3);
-- Tarif Première Classe

-- Pour le vol 3
INSERT INTO place_vol (prix, id_vol, id_type_siege)
VALUES (150.00, 3, 1), -- Tarif Economique
       (300.00, 3, 2), -- Tarif Business
       (500.00, 3, 3);
-- Tarif Première Classe

-- Insertion de données pour la table promotion
INSERT INTO promotion (nb_siege, pourcentage_reduction, id_type_siege, id_vol)
VALUES (3, 10.0, 1, 1), -- Promotion sur les sièges Economique pour le vol 1 (réduction de 10% à partir de 3 sièges)
       (2, 15.0, 2, 2), -- Promotion sur les sièges Business pour le vol 2 (réduction de 15% à partir de 2 sièges)
       (1, 5.0, 3, 3);
...
INSERT INTO reservation (prix, valider, nb_places, id_place_vol, id_utilisateur)
VALUES (120.50, true, 1, 1, 1), -- Réservation par Jean Dupont pour 1 siège Economique sur le vol 1
       (600.00, true, 2, 8, 3); -- Réservation par Alice Bernard pour 2 sièges Business sur le vol 3
